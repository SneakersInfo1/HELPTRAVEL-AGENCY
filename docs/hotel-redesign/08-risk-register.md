...
| R-03 | Dopasowanie taryfa↔pokój myli pokoje → **zdjęcie nie tego pokoju** | **wysokie** | wysoki — wprowadzenie w błąd przy zakupie | ręczny przegląd 20 hoteli: nazwa taryfy vs podpisane zdjęcie | próg podobieństwa + **placeholder zamiast zgadywania** (R10); zdjęcie hotelu nigdy jako zdjęcie pokoju |
