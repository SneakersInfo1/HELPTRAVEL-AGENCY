...
import { buildSiteStructuredData } from "@/lib/seo/site-schema";
...
export const metadata: Metadata = {
  ...
  alternates: {
    // Bez `canonical` na poziomie layoutu. Dziedziczyły go strony bez własnego
    // canonicala, więc np. /polubione i /loty/wyniki wskazywały stronę główną
    // jako kanoniczną (audyt SEO Growth V1). Strony do indeksu mają własny
    // canonical — strona główna w src/app/page.tsx.
    //
...
// WebSite, Organization i Service — lib/seo/site-schema.ts (wydzielone, żeby
// dało się je testować bez ładowania CSS i fontów layoutu).
const structuredData = buildSiteStructuredData(siteUrl);
