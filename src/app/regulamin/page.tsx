...
const sections: Section[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      `Serwis udostępnia narzędzie porównawcze „Lot + Hotel”, które zestawia niezależne oferty noclegu i przelotu dla wybranego kierunku wyłącznie w celu ułatwienia planowania. Zestawienie ma charakter informacyjny: prezentowane ceny noclegu i przelotu są cenami odrębnych świadczeń, a wskazywana obok suma orientacyjna („razem ok.”) nie stanowi ceny sprzedaży jednego świadczenia. Nocleg oraz przelot Użytkownik rezerwuje osobno, w ramach dwóch niezależnych umów i dwóch odrębnych płatności — nocleg zgodnie z § 8, a przelot zgodnie z § 10a. Operator nie łączy tych usług w jedną cenę łączną ani w jedną płatność i nie oferuje ich jako imprezy turystycznej. Rozliczenie płatności obsługuje partner rozliczeniowy (NUITEE TRAVEL), a stronami umów o poszczególne świadczenia pozostają odpowiednio Partner Rezerwacyjny (nocleg) oraz przewoźnik lub dostawca rezerwacji lotniczej (przelot); Operator występuje jako pośrednik.`,
    ],
  },
  {
    id: "uslugi",
