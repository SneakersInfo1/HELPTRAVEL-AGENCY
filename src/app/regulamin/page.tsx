...
const sections: Section[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      `Serwis udostępnia narzędzie porównawcze „Lot + Hotel”, które zestawia niezależne oferty noclegu i przelotu dla wybranego kierunku wyłącznie w celu ułatwienia planowania. Zestawienie ma charakter informacyjny i porównawczy: prezentowane ceny noclegu i przelotu są cenami odrębnych dostawców, a wskazywana obok suma orientacyjna („razem ok.”) nie stanowi ceny sprzedaży ani oferty nabycia jednego świadczenia. Rezerwację noclegu oraz rezerwację przelotu Użytkownik zawiera osobno, w ramach dwóch niezależnych umów z odpowiednimi dostawcami — nocleg za pośrednictwem infrastruktury Serwisu (§ 8), a przelot bezpośrednio u zewnętrznego dostawcy wyszukiwarki lotów, do którego Użytkownik jest przekierowywany. Operator nie łączy tych usług w jedną cenę łączną, nie pobiera jednej płatności za ich zestawienie i nie oferuje ich jako imprezy turystycznej ani powiązanych usług turystycznych w rozumieniu ustawy z dnia 24 listopada 2017 r. o imprezach turystycznych i powiązanych usługach turystycznych — w konsekwencji korzystanie z tego narzędzia nie tworzy po stronie Operatora obowiązków organizatora turystyki ani przedsiębiorcy ułatwiającego nabywanie powiązanych usług turystycznych.`,
    ],
  },
  {
    id: "uslugi",
