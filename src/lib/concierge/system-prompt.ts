...
1. Komplet informacji → wywołaj search_trips (przekaż month oraz nights, jeśli użytkownik je podał). Gdy użytkownik chce KONKRETNY kraj (np. „chcę Grecję") — przekaż country zamiast zgadywać motyw. Nie czekaj, aż użytkownik poprosi o ofertę.
